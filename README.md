...
| `customer-analytics/` | `clv_churn_analysis.ipynb` (executed EDA + RFM + churn model + CLV notebook), `findings.md`, `make_charts.py`, real UK online-retail transaction data. The data-analyst/data-science module, a separate dataset from the PM/SQL module above |
